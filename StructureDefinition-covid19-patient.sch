...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/eligible-for-vaccine']) &gt;= 1">extension with URL = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/eligible-for-vaccine': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/eligible-for-vaccine']) &lt;= 1">extension with URL = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/eligible-for-vaccine': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/area-type']) &gt;= 1">extension with URL = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/area-type': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/area-type']) &lt;= 1">extension with URL = 'https://jembi.github.io/covid19-immunization-ig//StructureDefinition/area-type': maximum cardinality of 'extension' is 1</sch:assert>
